...
int main(int argc, char* argv[]){
	...
	// // *********************************************************************
	// StackDoublyLinkedList<string> testing_push;
	...
	// // **********************************************************************
	// StackDoublyLinkedList<string> testing_pop;
	...
	// // **********************************************************************
	// StackDoublyLinkedList<int> testing_get_top;
	...
	// // **********************************************************************
	// StackDoublyLinkedList<int> testing_is_empty;
